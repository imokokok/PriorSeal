...
// These published fixture runtimes are content-addressed evidence. Their new
// TypeScript reference sources are checked, but rebuilding the historical
// JavaScript would change signed/exported package hashes.
const frozenExamples = new Map<string, { source: string; runtime: string }>([
