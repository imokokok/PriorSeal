...
function runtimePath(sourcePath: string): string {
  // Keep the SDK's existing rfc3161.mjs import and generated declaration file.
...
// esbuild removes types without validating them. Check every maintained source
// project before emitting executable JavaScript, including on test-only builds.
if (!check) {
