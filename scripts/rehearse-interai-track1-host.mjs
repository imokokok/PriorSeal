// Generated from rehearse-interai-track1-host.mts by npm run core:build. Do not edit directly.
...
const output = argv[1];
await mkdir(output, { mode: 448 });
await mkdir(path.join(output, "stage-logs"), { mode: 448 });
const beganAt = (/* @__PURE__ */ new Date()).toISOString();
const observations = [];
