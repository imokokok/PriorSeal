...
if (mode === 'typecheck') { run('./node_modules/.bin/tsc', ['-p', 'tsconfig.core.json', '--pretty', 'false']); run('./node_modules/.bin/tsc', ['-p', 'sdk/tsconfig.json', '--pretty', 'false']); run('./node_modules/.bin/tsc', ['-b', 'web/tsconfig.json', '--pretty', 'false']); process.exit(0); }
