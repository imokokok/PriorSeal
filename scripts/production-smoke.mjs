// Generated from production-smoke.mts by npm run core:build. Do not edit directly.
...
const pendingTimeoutMs = Number(process.env.PRIORSEAL_PENDING_TIMEOUT_MS ?? 72e4);
...
if (!Number.isSafeInteger(pendingTimeoutMs) || pendingTimeoutMs < 9e4 || pendingTimeoutMs > 9e5) {
