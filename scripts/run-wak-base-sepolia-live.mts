...
import type { Receipt } from '../sdk/dist/index.js';
...
const chainReceipt = await client.waitForTransactionReceipt({ hash: txHash, confirmations: 1, timeout: 180_000 });
