...
if (
  ...
  matchingExport.digest !== '0xa5bbfe64ca3864d7cf6d5ba0f5af1992b55d15100e0d716bd9e426b5812877a9' ||
  missingSubjectExport.digest !== '0x9a0476c3411cfdc40b59aad4e5c6ec656c662ca082e9e1ad2e28520e159de28a' ||
  subject?.schema !== subjectSchema ||
  missingCanonical.decisionSubject !== undefined
) {
...
async function makeReceipt(name, artifact) {
  ...
  const execution = {
    ...
    status: 'CONFIRMED',
    blockNumber: 33_300_000 + Number.parseInt(sha256(name).slice(0, 6), 16),
