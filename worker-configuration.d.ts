/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a52cbcec714af16e7fae9cca0b0b25c)
// Runtime types generated with workerd@1.20260907.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	OBSERVATION_QUEUE: Queue;
	HTTP_RATE_LIMITER: RateLimit;
	...
	PRIORSEAL_CORS_ORIGINS: "https://priorseal.xyz,https://www.priorseal.xyz";
	PRIORSEAL_TRUST_PROXY: "true";
	PRIORSEAL_PRIVATE_KEY_PEM: string;
	PRIORSEAL_PUBLIC_KEY_PEM: string;
	PRIORSEAL_POLICY_JSON: string;
	PRIORSEAL_ALLOW_SELF_ASSERTED_PRINCIPALS: string;
	PRIORSEAL_RPC_ETHEREUM: string;
	PRIORSEAL_RPC_BASE: string;
	PRIORSEAL_RPC_ARBITRUM: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/bootstrap/cloudflare-worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PRIORSEAL_ENVIRONMENT" | "PRIORSEAL_ISSUER" | "PRIORSEAL_KEY_ID" | "PRIORSEAL_AUTHORIZATION_AUDIENCE" | "PRIORSEAL_PREEXECUTION_PROOF_MODE" | "PRIORSEAL_CORS_ORIGINS" | "PRIORSEAL_TRUST_PROXY" | "PRIORSEAL_PRIVATE_KEY_PEM" | "PRIORSEAL_PUBLIC_KEY_PEM" | "PRIORSEAL_POLICY_JSON" | "PRIORSEAL_ALLOW_SELF_ASSERTED_PRINCIPALS" | "PRIORSEAL_RPC_ETHEREUM" | "PRIORSEAL_RPC_BASE" | "PRIORSEAL_RPC_ARBITRUM">> {}
}
