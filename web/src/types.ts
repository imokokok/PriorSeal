...
export type PolicyEvidence = { schema: 'priorseal.policy-evidence.v1'; policyHash: string; document: Record<string, unknown> | null; result: { allowed: boolean; reasonCodes: string[]; policyId: string | null; evaluatedAt: number } }
