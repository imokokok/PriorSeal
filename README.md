...
The maintainer-aligned [APS × PriorSeal sibling-adapter claim boundary](docs/architecture/aps-priorseal-claim-boundary.md) pins the APS 6.0.1 public verifier and PriorSeal SDK 0.4.0, keeps both trust domains separate, and explicitly declines to claim APS decision-level single use. It is a pre-implementation design awaiting APS-maintainer-produced decision fixtures, not yet a runnable integration.
