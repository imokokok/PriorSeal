...
const schema = receipt !== null && typeof receipt === 'object' && 'schema' in receipt ? receipt.schema : undefined;
const result = typeof schema === 'string' && ['priorseal.execution-receipt.v2', 'priorseal.execution-receipt.v3'].includes(schema)
