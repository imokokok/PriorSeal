// Generated from workflow-fixture.mts by npm run core:build. Do not edit directly.
...
async function workflowFixture(prior, insight = prior) {
  ...
  const store = createMemoryStore({ clock: () => f.now * 1e3 });
  const accepted = await authorizeIntent({ input: authorization, store, privateKeyPem, issuer: "simulation-rwa-v2", keyId: "simulation", now: () => f.now * 1e3 });
