// Generated from create-signed-receipt.mts by npm run core:build. Do not edit directly.
...
const store = createMemoryStore({ clock: () => (now - 30) * 1e3 });
const accepted = await authorizeIntent({ input: authorization, store, privateKeyPem, issuer: "priorseal-example-attester", keyId: "example-1", now: () => (now - 30) * 1e3 });
const execution = {
  chainId: 8453,
...
console.log(`Compliance:  ${receipt.compliance?.status ?? "NOT_ASSESSABLE"}`);
