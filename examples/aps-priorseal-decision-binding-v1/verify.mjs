...
export async function runExample() {
  ...
  assert.equal(cases[0].composition.decisionRef, cases[3].composition.decisionRef);
  assert.notEqual(cases[0].composition.authorizationId, cases[3].composition.authorizationId);
