...
export async function signTestAuthorization(intent, name, edits = {}) {
...
export function receiptFromAuthorization(authorization, name, executionEdits = {}) {
...
export async function makeTestReceipt({ apsCase = 'permit', name = apsCase, nonce = '7',
  editIntent = (intent) => intent, executionEdits = {} } = {}) {
