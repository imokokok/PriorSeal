...
export function verifyThoughtProofExport(artifact, keyDocument, expected, { allowVectorOnly = false } = {}) {
...
export function verifyExactCallDecisionSubject(canonical, intent, expected) {
...
export function verifyCalldataFixtures(fixtures) {
...
export function verifySubjectFixtures(fixtures, expected) {
  if (!isRecord(fixtures) || !Array.isArray(fixtures.cases) || fixtures.cases.length < 1) {
