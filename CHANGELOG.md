...
- Added a TypeScript SDK for browser and Node.js integrations, wallet authorization, execution observation and evidence retrieval; the console now consumes the SDK and includes a dedicated integration workspace.
