...
| Authorization | complete intent, principal, authorizer, delegate, time window, nonce, audience, policy hash and signature | `ACCEPTED → BOUND`; the first available transaction hash consumes its single use |
