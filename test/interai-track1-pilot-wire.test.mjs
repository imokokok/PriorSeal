// Generated from interai-track1-pilot-wire.test.mts by npm run core:build. Do not edit directly.
...
const releaseId = "0x6e3bd18c541cc80e326754a7743f05050df348257102b93f9a13bc82c7e69f6b";
...
const calldata = "0x04e45aaf00000000";
const projection = {
  chainId: 84532,
  sender,
  target,
...
const candidate = {
  ...
  packageId: "interai-track1-base-sepolia-1790230000-11111111-2222-4333-8444-555555555555",
  canonicalAction: {
...
async function fixture(directory, sourceAssertion = source) {
  const files = {
  ...
  await Promise.all(
    Object.entries(files).map(
      ([name, value]) => writeFile(path.join(directory, name), JSON.stringify(value))
    )
  );
}
...
test("JIT registry and signed descriptor drift fail closed", async () => {
  ...
  try {
    ...
    for (const mutate of [
      ...
      (value) => {
        value.schemas.OracleSafetyCheck.eip712.types.OracleSafetyCheck[0].type = "bytes32";
      },
      (value) => {
