// Generated from runtime-config.test.mts by npm run core:build. Do not edit directly.
...
test("runtime configuration normalizes explicit startup dependencies", () => {
  ...
  assert.deepEqual(config, {
    ...
    policyFile: void 0,
    transparencyAnchorFile: void 0,
    witnessEndpointsFile: void 0,
...
test("production runtime fails closed unless security dependencies are explicit", () => {
  const base = {
    ...
    PRIORSEAL_ISSUER: "priorseal-prod",
    PRIORSEAL_KEY_ID: "prod-1",
    PRIORSEAL_BUILD_VERSION: "0.2.0",
    PRIORSEAL_AUTHORIZATION_AUDIENCE: "priorseal.example.com",
    PRIORSEAL_PRIVATE_KEY_FILE: "/private.pem",
    PRIORSEAL_PUBLIC_KEY_FILE: "/public.pem",
    PRIORSEAL_POLICY_FILE: "/policy.json",
    PRIORSEAL_REQUIRE_EXTERNAL_ANCHOR: "true",
    PRIORSEAL_TRANSPARENCY_ANCHOR_FILE: "/anchor.json",
    PRIORSEAL_CORS_ORIGINS: "https://priorseal.example.com",
    DATABASE_URL: "postgresql://app:secret@db.example/priorseal?sslmode=verify-full",
    DATABASE_URL_UNPOOLED: "postgresql://app:secret@db.example/priorseal?sslmode=verify-full"
  };
