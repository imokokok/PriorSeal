...
export const contentId = (body) => keccak256(toBytes(canonicalJson(body)));
export function snapshotPin(snapshot) {
...
export async function createSignedExecution({ signer, version = 5, overrides = {} }) {
