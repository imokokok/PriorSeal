...
import type { VerificationBundle } from '../../sdk/dist/index.js';
...
function fixture() {
  ...
  const bundle = buildVerificationBundle({ receipt, keyRegistry: { schema: 'priorseal.keys.v1', issuer: 'test', keys: [key] }, assembledAt: 1101 }) as unknown as VerificationBundle;
  return { key, bundle };
}
