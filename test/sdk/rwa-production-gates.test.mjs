// Generated from rwa-production-gates.test.mts by npm run core:build. Do not edit directly.
...
function fixture() {
  const f = rwaV2Fixture(sdk), profile = executionRegistry.profiles[0].profile, instrumentId = sdk.rwaInstrumentId(instrument);
...
test("Robinhood production profile constructs and decodes the pinned deadline-protected call", () => {
  const f = fixture(), semantics = sdk.decodeRwaCall(
    f.transaction,
    f.input.request,
    f.input.instrument,
    f.callProfile,
...
test("PriorSeal independently requires the signed production admission commitment", async () => {
  const f = fixture(), signer = privateKeyToAccount("0x" + "12".repeat(32)), instrumentAdmission = {
