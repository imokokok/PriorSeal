// Generated from thoughtproof-sentinel-paired.test.mts by npm run core:build. Do not edit directly.
...
test("retired production kid remains verifiable for an artifact signed in its window", () => {
  ...
  key.status = "retired";
  key.notAfter = new Date((artifact.signedAt + 1) * 1e3).toISOString();
