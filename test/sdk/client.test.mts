...
import type { Eip1193Provider, Intent } from '../../sdk/dist/index.js';
...
test('SDK wallet helper prepares, signs and accepts an authorization', async (t) => {
  ...
  const flow = await client.authorizeWithWallet({ intent: authorization.intent as Intent, principal: { type: 'user', id: 'user:1' }, delegate: authorization.delegate, issuedAt: 1_000, authorizationNonce: authorization.authorizationNonce }, provider);
