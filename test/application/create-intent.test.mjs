// Generated from create-intent.test.mts by npm run core:build. Do not edit directly.
...
test("create intent rejects misleading exact-call semantic policy constraints", async () => {
  ...
  await assert.rejects(
    ...
    (error) => hasCode(error, "POLICY_REJECTED") && typeof error.details === "object" && error.details !== null && "reasonCodes" in error.details && Array.isArray(error.details.reasonCodes) && error.details.reasonCodes.includes("POLICY_EXACT_CALL_SEMANTICS_UNSUPPORTED")
  );
});
