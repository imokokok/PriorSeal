// Generated from safe-json.test.mts by npm run core:build. Do not edit directly.
...
test("migrated JSON guards preserve identity and reject unsafe input", () => {
  ...
  assert.throws(() => assertOnlyFields({ extra: true }, ["child"], "sample"), (error) => hasCode(error, "UNKNOWN_FIELD") && typeof error.details === "object" && error.details !== null && "fields" in error.details && Array.isArray(error.details.fields) && error.details.fields[0] === "extra");
});
