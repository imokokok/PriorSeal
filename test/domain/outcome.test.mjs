// Generated from outcome.test.mts by npm run core:build. Do not edit directly.
import test from "node:test";
import assert from "node:assert/strict";
import { classifyOutcome } from "../../src/domain/outcome.mjs";
const intent = { chainId: 8453, action: "TRANSFER", sender: "0xaa", recipient: "0xbb", asset: "native", amount: "10", nonce: "1", validUntil: 1e3 };
