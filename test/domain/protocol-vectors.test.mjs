// Generated from protocol-vectors.test.mts by npm run core:build. Do not edit directly.
...
test("protocol golden vectors preserve canonical bytes and intent hash", () => {
  ...
  const intent = buildIntent({ intentId: "vector-1", chainId: "eip155:1", action: "TRANSFER", asset: "eip155:1/native", amount: "1", sender: `0x${"1".repeat(40)}`, recipient: `0x${"2".repeat(40)}`, validUntil: 2e9 });
...
test("canonical JSON rejects values that cannot be encoded", () => {
  ...
  assert.throws(() => canonicalize({ value: void 0 }), /undefined is not valid canonical JSON/);
});
test("exact-call intent retains its pre-migration hash and commitment order", () => {
  const intent = buildIntent({
    ...
    intentId: "typed-migration-vector",
    chainId: 8453,
  ...
  assert.ok(intent.contextCommitments);
