...
export function signReceipt<T extends Record<string, unknown>>(receipt: T, privateKeyPem: string) { return signEd25519Statement(receipt, privateKeyPem); }
export function verifySignature(receipt: Record<string, unknown> | null | undefined, publicKeyPem: string): boolean { return verifyEd25519Statement(receipt, publicKeyPem); }
