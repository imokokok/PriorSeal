// Generated from ed25519.mts by npm run core:build. Do not edit directly.
...
function signEd25519Statement(statement, privateKeyPem) {
...
function assertEd25519KeyPair(privateKeyPem, publicKeyPem) {
