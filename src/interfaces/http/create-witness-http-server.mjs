// Generated from create-witness-http-server.mts by npm run core:build. Do not edit directly.
...
function createWitnessHttpServer({ witnessId, keyId = "default", privateKeyPem, publicKeyPem, store = createMemoryWitnessStore(), bearerToken, maxBodyBytes = 16 * 1024, rateLimit = 120, rateLimiter = createMemoryRateLimiter({ limit: rateLimit }), requestTimeoutMs = 1e4, maxRequestAgeSeconds = 300, now = () => Date.now(), logger = null } = {}) {
