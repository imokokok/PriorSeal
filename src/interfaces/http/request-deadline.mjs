// Generated from request-deadline.mts by npm run core:build. Do not edit directly.
import { PriorSealError } from "../../domain/errors.mjs";
function createRequestDeadline(req, timeoutMs) {
  ...
  return {
    ...
    run(operation) {
      return new Promise((resolve, reject) => {
        ...
        const onAbort = () => {
          if (finish()) reject(controller.signal.reason ?? new PriorSealError("REQUEST_ABORTED", "Request was aborted"));
        };
