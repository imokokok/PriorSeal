...
export async function deploymentCapabilities({ issuer, audience, keyConfigured, policy, proofMode, timestampConfigured, witnessConfigured, anchorConfigured, rpcChainIds, store, archiveEnabled, contractSignatureConfigured = false, now }) {
