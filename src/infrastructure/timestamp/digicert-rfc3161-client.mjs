// Generated from digicert-rfc3161-client.mts by npm run core:build. Do not edit directly.
...
function createDigiCertTimestampProvider({ fetchImpl = globalThis.fetch, timeoutMs = 1e4 } = {}) {
  if (typeof fetchImpl !== "function") throw new TypeError("RFC 3161 timestamp provider requires fetch");
  if (!Number.isSafeInteger(timeoutMs) || timeoutMs < 1 || timeoutMs > 6e4) throw new TypeError("RFC 3161 timeout must be between 1 and 60000 ms");
