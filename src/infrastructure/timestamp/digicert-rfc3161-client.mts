...
import type { TimestampPolicy } from '../../domain/rfc3161.mjs';
...
export function createDigiCertTimestampProvider({ fetchImpl = globalThis.fetch, timeoutMs = 10_000 } = {}) {
  ...
  return async ({ authorization, acceptance, policy }: { authorization: object; acceptance: { acceptedAt: number }; policy: TimestampPolicy }) => {
