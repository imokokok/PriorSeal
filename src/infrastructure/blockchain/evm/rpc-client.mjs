    ...
    async call(url, method, params, signal) {
      ...
      for (let attempt = 0; attempt <= retries; attempt += 1) {
        ...
        try {
          ...
          if (!body || typeof body !== "object" || !("jsonrpc" in body) || body.jsonrpc !== "2.0" || !("id" in body) || body.id !== 1) throw rpcError("RPC_INVALID_RESPONSE", "RPC endpoint returned an invalid JSON-RPC envelope");
          const envelope = body;
