export function createMemoryStore() { const intents = new Map(), receipts = new Map(), observations = new Map(), idempotency = new Map(), jobs = new Map(); return {
  ...
  async getObservation(chainId, txHash) { return observations.get(`${chainId}:${txHash}`); },
